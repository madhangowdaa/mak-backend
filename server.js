...
import fourKMovieRoutes from "./routes/4kMovies.js";
...
const downloadLimiter = rateLimit({
    ...
    message: { error: "Too many download attempts" }
});
...
app.use("/api/movies/download", downloadLimiter);
app.use("/api", fourKMovieRoutes);
